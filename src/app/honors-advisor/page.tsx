...
export default function HonorsAdvisorPage() {
    ...
    const findImage = (courseTitle: string) => {
        ...
        const keywordMap: { [key: string]: string } = {
            ...
            'circuit complexity': 'hardware',
            'computational number theory': 'math',
            'advanced computer networks': 'software',
            'scalable data science': 'data',
            'foundations of cryptography': 'cybersecurity',
            ...
            'quantum': 'physics',
            'usable security': 'cybersecurity',
            'human-computer interaction': 'ux',
            'linear programming': 'math',
            'affective computing': 'ai/ml',
            'cyber physical': 'iot',
            'information security': 'cybersecurity',
            'c++': 'software',
            'secure computation': 'cybersecurity',
            'computer vision': 'ai/ml',
            'compiler': 'software',
            'network': 'software',
            'hacking': 'cybersecurity',
            'computation': 'math',
            'drug design': 'pharmacist',
            'statistics': 'data',
            'time series': 'data',
            'analytics': 'data',
            'big data': 'data',
            ...
            'wavelets': 'math',
            'multirate': 'electrical',
            'medical image': 'doctor',
            ...
            'nuclear power': 'mechanical',
            'ergonomics': 'human',
            'fluid dynamics': 'mechanical',
            'welding': 'mechanical',
            'casting': 'mechanical',
            'vibration': 'mechanical',
            'steam and gas': 'mechanical',
            'turbomachinery': 'mechanical',
            'power plant': 'mechanical',
            'heat exchangers': 'mechanical',
            'continuum mechanics': 'mechanical',
            'mechanism': 'mechanical',
            'robot': 'robotics',
            'mechatronics': 'robotics',
            'sheet metal': 'mechanical',
            'refrigeration': 'mechanical',
            'fault diagnosis': 'mechanical',
            'fluid machines': 'mechanical',
